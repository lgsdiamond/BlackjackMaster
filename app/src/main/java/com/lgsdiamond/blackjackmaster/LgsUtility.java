...
import com.lgsdiamond.blackjackmaster.blackjackelement.Card;
...
public class LgsUtility {
    ...
    static void showToastShort(String message) {
...
//    public static void postInitialize(MainActivity activity) {
...
//                MainActivity.sStudioHandler.postDelayed(new Runnable() {
//                    @Override
//                    public void run() {
