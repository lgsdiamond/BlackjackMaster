...
package com.outsource.mpchart.renderer;
...
public abstract class DataRenderer extends Renderer {
    ...
    public void drawValue(Canvas c, ValueFormatter formatter, float value, Entry entry, int dataSetIndex, float x, float y) {
        //(lgsdiamond: original coding-(o))
        //(o)c.drawText(formatter.getFormattedValue(value, entry, dataSetIndex, mViewPortHandler), x, y, mValuePaint);

        //(lgsdiamond: revised coding-all below)
        ValueFormatter entryFormatter = entry.getValueFormatter();
        if (entryFormatter == null) {
            c.drawText(formatter.getFormattedValue(value, entry, dataSetIndex, mViewPortHandler), x, y, mValuePaint);
        } else {
            c.drawText(entryFormatter.getFormattedValue(value, entry, dataSetIndex, mViewPortHandler), x, y, mValuePaint);
        }
    }
